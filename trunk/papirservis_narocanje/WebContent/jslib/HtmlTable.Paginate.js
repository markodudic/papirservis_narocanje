                ...
                if(this.body.rows != undefined){                
                    var numOfRows = this.body.rows.length;
                        if(numOfRows>0){
                            ...
                            liPreviousSpan.set('html',MooTools.lang.get('msg','dispatcher.prejsnja'));
                            ...
                            if((endIndex-startIndex)>1){//avoid 1 page pagination
                                ...
                                liNextSpan.set('html',MooTools.lang.get('msg','dispatcher.naslednja'));
                            ...
                            if(this.options.paginateRowsSelector!=null && this.options.paginateRowsSelector.length>1){
                                ...
                                rowSpan.set('html',MooTools.lang.get('msg','dispatcher.vrstic'));
